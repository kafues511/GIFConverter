...
class QuantizeMethod:
    def __init__(
        ...
        **kwargs,
        ...
        mediancut_radiobutton.grid(column=grid.column+1, row=grid.row, pady=(5, 0), sticky=grid.sticky)
        ...
        fastoctree_radiobutton.grid(column=grid.column+2, row=grid.row, pady=(5, 0), sticky=grid.sticky)
